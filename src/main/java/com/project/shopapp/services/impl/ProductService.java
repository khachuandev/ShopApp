...
public class ProductService implements IProductService {
    ...
    public void deleteProduct(long id) {
        ...
        //optionalProduct.ifPresent(product -> productRepository.deleteById(product.getId())); Kiem tra roi moi xoa
        optionalProduct.ifPresent(productRepository::delete); // xoa luon ko kiem tra nen co the ko tim thay san pham
    }
